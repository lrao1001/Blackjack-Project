...
tkinter.Label(mainWindow, text="Blackjack by FL_Supreme", font=fontStyle1).grid(row=0, column=0)

# text = tkinter.Label(mainWindow, text="Blackjack by FL_Supreme", font=fontStyle1)
# text.bind("<Enter>", partial(font_config, text, "Helvetica 9 italic"))
# text.bind("<Leave>", partial(font_config, text, "Helvetica 9"))
# text.grid(row=0, column=0)


fontStyle = tkFont.Font(family='Constantia', size=20, weight='bold')
...
card_frame.grid(row=2, column=0, sticky='ew', columnspan=3, rowspan=2)

dealer_score_label = tkinter.IntVar()
tkinter.Label(card_frame, text="Dealer", background="green", fg='white').grid(row=1, column=0)
tkinter.Label(card_frame, textvariable=dealer_score_label, background="green", fg="white").grid(row=2, column=0)
# embedded frame to hold the card images
dealer_card_frame = tkinter.Frame(card_frame, background="green")
...
dealer_button.grid(row=1, column=0)
...
shuffle_button.grid(row=1, column=3)
